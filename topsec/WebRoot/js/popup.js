...
build:function(){
   ...
   // var close='<input type="image" id="dialogBoxClose"
	// src="'+path+'dialogclose.gif" border="0" width="16" height="16"
	// align="absmiddle" title="关闭"/>';
   var close='<img id="dialogBoxClose" title="关闭" src=../img/dialogclose.gif  />';
