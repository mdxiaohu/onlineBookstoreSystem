		        ...
		        <div class="left_row">
		             <div class="list pic_news">
	        				...
	        				<table>
			                   ...
			                   <tr>
			                       <td width="120"></td>
			                       <td><a href="#" onclick="clearCart()"><img border="0" src="<%=path %>/img/Car_icon_01.gif"/></a></td>
			                       <td><a href="<%=path %>/qiantai/default.jsp"><img border="0" src="<%=path %>/img/Car_icon_02.gif"/></a></td>
			                       <td><a href="<%=path %>/orderQueren.action"><img border="0" src="<%=path %>/img/Car_icon_03.gif"/></a></td>
			                   </tr>
			               </table>
		             </div>
		         </div>	
