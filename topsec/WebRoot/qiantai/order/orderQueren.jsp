		            ...
		            <div class="list pic_news">
						  	...
						  	<form action="<%=path %>/orderSubmit.action" name="f" method="post">
		                        <table width="99%" border="0" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" align="center" style="margin-top:8px">
					              ...
					              <tr align='center' bgcolor="#FFFFFF" height="22">
					                  <td>送货地址：</td>
					                  <td><input type="text" name="odderSonghuodizhi"  value="陕西省"/></td>
					              </tr>
					              <tr align='center' bgcolor="#FFFFFF" height="22">
					                  <td>付款方式：</td>
					                  <td>
		   		                          <select name="odderFukuangfangshi" style="width:155px;">
		   		                               <option value="积分消费">积分消费</option>
					              ...
					              <tr align='center' bgcolor="#FFFFFF" height="22">
					              <td> </td>
					                 <td ><span style="color:red;font-size:14px" ><s:property   value="#request.SYJF"/></span></td>
					              </tr>
		        				</table>
		        				<table>
				                   ...
				                   <tr>
				                       <td width="120"></td>
				                       <td><a href="#" onclick="back1()"><img border="0" src="<%=path %>/img/Car_icon_back.gif"/></a></td>
				                       <td><img border="0" src="<%=path %>/img/Car_icon_06.gif" onclick="javascript:document.f.submit();"/></td>
				                   </tr>
				               </table>
				            </form>
		             </div>
